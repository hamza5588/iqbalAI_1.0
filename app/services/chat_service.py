    ...
    def process_message(self, message: str, 
        ...
        try:
            ...
            base_prompt = (
                ...
                "If any one asks about the data say the data is crawled from the internet if user not ask about the data then no need to say the data is crawled from the internet"
            )
